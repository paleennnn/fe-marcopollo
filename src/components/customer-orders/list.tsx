  ...
  const safeTableProps = {
    ...
    dataSource: Array.isArray(apiData)
      ? apiData.map((item: any) => ({
          ...
          tanggalSelesai: item.tanggalSelesai, // Needed for refund check
  ...
  const expandedRowRender = (record: any) => {
    return (
      ...
      >
        ...
        />
        <Table.Column title="Qty" dataIndex="jumlah" align="center" />
        <Table.Column
          title="Subtotal"
          dataIndex="subtotal"
          align="right"
                ...
                return (
                  <Space direction="vertical" size={4}>
                    ...
                    <Button
                      ...
                      size="small"
                      type="dashed"
                      onClick={() => handleCancelRefund(item.refund.id)}
                    >
                      Batal Ajukan
                    </Button>
                  </Space>
